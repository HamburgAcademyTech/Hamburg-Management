...
class FirebaseStudentITRepo : StudentRepository {
    private val firestore = Firebase.firestore

    override fun getStudents() = flow {
        firestore.collection("Students_IT").snapshots.collect { querySnapshot ->
    ...
    override fun getStudentById(id: String) = flow {
        firestore.collection("Students_IT").document(id).snapshots.collect { documentSnapshot ->
    ...
    override suspend fun addStudent(student: Student) {
        ...
        firestore.collection("Students_IT")
            .document(studentId)
            .set(student.copy(id = studentId))
    }

    override suspend fun updateStudent(student: Student) {
        firestore.collection("Students_IT").document(student.id).set(student)
    }

    override suspend fun deleteStudent(student: Student) {
        firestore.collection("Students_IT").document(student.id).delete()
    }
